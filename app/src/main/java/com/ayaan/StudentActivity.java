...
public class StudentActivity extends ListActivity {
	...
	public EditText mark1;
	public EditText mark2;
	public EditText mark3;
	public String ssusn;
	public String ssphone;
	public String sscode;
	public String ssname;
	public String smark1;
	public String smark2;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mark1=(EditText)findViewById(R.id.xmark1);
		mark2=(EditText)findViewById(R.id.xmark2);
		mark3=(EditText)findViewById(R.id.xmark3);
	...
	public void home_start1(View v)
	{
		...
		sscode = scode.getText().toString();
		smark1=mark1.getText().toString();
		smark2=mark2.getText().toString();
		smark3=mark3.getText().toString();
